# Generated by Django 5.2.6 on 2026-03-08 13:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teacher', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='subjects', to='attendance.teacher')),
            ],
        ),
        migrations.CreateModel(
            name='Attendance',
        ...
        migrations.CreateModel(
            ...
            options={
                'unique_together': {('day', 'hour', 'class_name', 'section')},
            },
        ),
    ]
